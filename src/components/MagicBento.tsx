...
const cardData: BentoCardProps[] = [
  {
    ...
    description: 'End-to-end support for early-stage ventures',
    label: '🚀 Launchpad'
  },
  {
    color: '#060010',
    title: 'Hackathons',
    description: '48-hour builds, real-world problems',
    label: '⚡ Build'
  },
  {
    color: '#060010',
    title: 'Mentorship',
    description: 'Learn directly from industry leaders & founders',
    label: '🧠 Guidance'
  },
  {
    color: '#060010',
    title: 'Ideathons',
    description: 'Validate and pitch your boldest ideas',
    label: '💡 Ideate'
  },
  {
    color: '#060010',
    title: 'Funding Access',
    description: 'Connect with investors & grant programs',
    label: '💰 Capital'
  },
  {
    color: '#060010',
    title: 'Community',
    description: '10,000+ builders, makers & dreamers',
    label: '🌐 Network'
  }
];
